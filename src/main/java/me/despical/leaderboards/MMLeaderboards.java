...
public class MMLeaderboards extends Leaderboard {
    ...
    public String onPlaceholderRequest(Player player, @NotNull String id) {
        ...
        if (id.contains("wins_murderer")) {
            final String request = handlePlaceholderRequest(id, "top_wins_murderer_name_", "top_wins_murderer_value_", subId, StatsStorage.StatisticType.WINS_MURDERER);
        ...
        if (id.contains("wins_detective")) {
            final String request = handlePlaceholderRequest(id, "top_wins_detective_name_", "top_wins_detective_value_", subId, StatsStorage.StatisticType.WINS_DETECTIVE);
        ...
        if (id.contains("wins_hero")) {
            final String request = handlePlaceholderRequest(id, "top_wins_hero_name_", "top_wins_hero_value_", subId, StatsStorage.StatisticType.WINS_HERO);
        ...
        if (id.contains("loses_murderer")) {
            final String request = handlePlaceholderRequest(id, "top_loses_murderer_name_", "top_loses_murderer_value_", subId, StatsStorage.StatisticType.LOSES_MURDERER);
        ...
        if (id.contains("loses_detective")) {
            final String request = handlePlaceholderRequest(id, "top_loses_detective_name_", "top_loses_detective_value_", subId, StatsStorage.StatisticType.LOSES_DETECTIVE);
        ...
        if (id.contains("loses_hero")) {
            final String request = handlePlaceholderRequest(id, "top_loses_hero_name_", "top_loses_hero_value_", subId, StatsStorage.StatisticType.LOSES_HERO);
